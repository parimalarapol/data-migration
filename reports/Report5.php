...
FROM ALBUM a,
  ALBUM_FACTS_TABLE f
WHERE a.album_id = f.album_id
AND revenue      =
  (SELECT MIN(revenue) FROM performance
  ) " ;
...
ociexecute($sql_id , OCI_DEFAULT);
  ...
  print "<b><div align=\"center\"><font color=\"blue\"><font size=\"6\">Report details for which album has minimum revenue till date.</font></b></div><br>\n";
